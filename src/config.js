...
const CONFIG = {
  ...
  enemy: {
    ...
    kamikaze: { hp: 6,  speed: 235, radius: 19, score: 520, color: "#ff4d4f", fireInterval: 0,   bulletSpeed: 0,   damage: 0, move: "rearChase", fromBottom: true, crashDamage: 38 },
  },
  ...
  moves: {
    ...
    rearChase:{ speedMul: 1, warn: 2, boost: 2, boostMul: 1.85, turn: 4.6 }, // 从屏幕后方出现,警告后短时冲刺追撞
  ...
  powerup: { radius: 14, speed: 130, dropChance: 0.14, healAmount: 12, autoInterval: 5, magnetRadius: 40, magnetSpeed: 640, chipMinPower: 5, chipMinEndlessTime: 30, chipDraftInterval: 30, chipBossDraftDelay: 30, chipMinDraftGap: 30,
    weights:        { power: 0.47, heal: 0.22, bomb: 0.12, wing: 0.14, chip: 0.05 },
    endlessWeights: { power: 0.56, heal: 0.18, bomb: 0.025, wing: 0.11, chip: 0.125 } },
  overflow: { healShield: 22, healShieldDur: 6, bombEnergy: 18, wingChip: "sideGuns", threatGain: 22, score: 160 },
  threat: {
  ...
  chips: {
    laserFocus: { name: "聚焦激光", desc: "激光更窄,伤害更高", color: "#cc5de8", duration: 10, laserWidthMult: 0.78, laserDamageBonus: 1, laserDurationBonus: 0.04 },
    homingSwarm: { name: "蜂群追踪", desc: "追踪弹更多,锁定更远", color: "#4dabf7", duration: 10, intervalMult: 0.80, extraCount: 1, targetRange: 400, damageBonus: 1 },
    missileBarrage: { name: "导弹齐射", desc: "导弹更多,爆炸范围扩大", color: "#ff922b", duration: 10, intervalMult: 0.84, extraCount: 1, damageBonus: 1, splashMult: 1.16 },
    chargeCore: { name: "蓄能核心", desc: "蓄力更快,冷却更短", color: "#ffd43b", duration: 9, chargeRate: 1.30, cooldownMult: 0.72, boostBonus: 2 },
    capacitor: { name: "电容护盾", desc: "过载层可抵消伤害", color: "#74c0fc", duration: 12, block: 16 },
  ...
  bonuses: {
    damage: { name: "火力校准", desc: "全武器伤害 +10%", color: "#ff6b6b", damageMult: 0.10 },
    fireRate: { name: "加速扳机", desc: "主炮/副武器射速 +7%", color: "#4dabf7", cooldownMult: 0.07 },
    range: { name: "远程弹道", desc: "锁定距离和激光持续 +15%", color: "#51cf66", rangeMult: 0.15 },
    maxHp: { name: "装甲扩容", desc: "最大生命 +10 并治疗", color: "#38d9a9", weight: 130, hp: 10 },
    reinforcedHull: { name: "复合装甲", desc: "最大生命 +8% 并治疗,累计最多 +48", color: "#20c997", rarity: "稀有", weight: 58, hpPct: 0.08, maxHp: 48 },
    armorPlating: { name: "钛合装甲", desc: "承受伤害 -6%", color: "#74c0fc", rarity: "稀有", weight: 50, damageReductionMult: 0.06 },
    fieldRepair: { name: "纳米修复", desc: "4秒未受击后每秒回复1.5%最大生命", color: "#69db7c", rarity: "稀有", weight: 42, healPct: 0.015, delay: 4, tick: 1 },
    repairLoop: { name: "维修循环", desc: "每14秒恢复4.5%最大生命,满血转临时护盾", color: "#38d9a9", rarity: "稀有", weight: 36, every: 14, healPct: 0.045, shield: 6, maxShield: 30, dur: 5 },
    repairPulse: { name: "维修脉冲", desc: "治疗补给和维修循环会震击近身敌人", color: "#69db7c", rarity: "稀有", weight: 30, damage: 6, range: 155 },
    leech: { name: "吸能核心", desc: "击杀回复 1 生命,冷却 1.4 秒", color: "#e64980", heal: 1, cooldown: 1.4 },
    ...
    shieldAmplifier: { name: "护盾放大器", desc: "有护盾时全武器伤害 +12%", color: "#74c0fc", rarity: "稀有", weight: 34, damageMult: 0.12 },
    shieldBreaker: { name: "破盾电荷", desc: "对敌方护盾伤害 +45%,击破护盾时震击附近敌人", color: "#74c0fc", rarity: "稀有", weight: 34, shieldDamageMult: 0.45, breakDamage: 5, range: 140 },
    ...
    armorPiercer: { name: "破甲弹芯", desc: "主炮对高生命敌机伤害 +25%", color: "#ff922b", rarity: "稀有", weight: 34, minHp: 12, heavyDamageMult: 0.25 },
    armorCaliber: { name: "装甲口径", desc: "每15额外最大生命,主炮伤害 +1,每层最多 +4", color: "#38d9a9", rarity: "稀有", weight: 32, hpPerDamage: 15, maxDamage: 4 },
    vitalReactor: { name: "生命炉心", desc: "每20额外最大生命,全武器伤害 +3%,每层最多 +15%", color: "#20c997", rarity: "稀有", weight: 30, hpPerDamageMult: 20, damageMult: 0.03, maxDamageMult: 0.15 },
    stableFire: { name: "稳态火控", desc: "生命高于70%时全武器伤害 +12%", color: "#38d9a9", rarity: "稀有", weight: 32, hpThreshold: 0.70, damageMult: 0.12 },
    perfectLine: { name: "完美航线", desc: "8秒未受击后伤害 +10%,射速 +6%", color: "#69db7c", rarity: "稀有", weight: 30, delay: 8, damageMult: 0.10, cooldownMult: 0.06 },
    ...
    swarmCore: { name: "蜂群协议", desc: "追踪弹 +1,锁定和伤害提升", color: "#4dabf7", rarity: "稀有", weight: 38, extraCount: 1, homingDamage: 1, targetRangeMult: 0.08 },
    ...
    explosivePayload: { name: "高爆载荷", desc: "导弹伤害和爆炸范围提升", color: "#ff922b", rarity: "稀有", weight: 38, missileDamage: 2, splashMult: 0.18 },
    ...
    comboBattery: { name: "连击电池", desc: "每 10 连击获得能量和护盾", color: "#ffd43b", rarity: "稀有", weight: 36, energy: 12, shield: 6, dur: 4 },
    ...
    executioner: { name: "处决算法", desc: "对 40% 血以下敌人伤害 +22%", color: "#e64980", rarity: "稀有", weight: 34, threshold: 0.4, damageMult: 0.22 },
    eliteHunter: { name: "王牌猎手", desc: "对精英敌伤害 +25%", color: "#ff6b6b", rarity: "稀有", weight: 32, eliteDamageMult: 0.25 },
    reactiveArmor: { name: "反应装甲", desc: "护盾格挡时震击近身敌人", color: "#74c0fc", rarity: "稀有", weight: 30, damage: 6, range: 160 },
    lastStand: { name: "黑匣子保险", desc: "致命伤保留 1 生命并展开护盾", color: "#845ef7", rarity: "史诗", weight: 12, shield: 24, maxShield: 70, dur: 5, cooldown: 80 },
    glassCannon: { name: "玻璃大炮", desc: "全武器伤害 +25%,承伤 +22%", color: "#ff6b6b", rarity: "稀有", weight: 28, damageMult: 0.25, damageTakenMult: 0.22 },
    bossHunter: { name: "猎首协议", desc: "对 Boss 伤害 +28%", color: "#cc5de8", rarity: "稀有", weight: 30, bossDamageMult: 0.28 },
    weakScanner: { name: "弱点标定", desc: "Boss弱点窗口 +0.3秒,弱点伤害 +18%", color: "#ffd43b", rarity: "稀有", weight: 26, weakDamageMult: 0.18, weakDuration: 0.3 },
    adrenaline: { name: "肾上腺素", desc: "半血以下伤害和射速提升", color: "#ff8787", rarity: "史诗", weight: 16, threshold: 0.5, damageMult: 0.22, cooldownMult: 0.12 },
    emergencyBarrier: { name: "应急力场", desc: "低血量受伤自动展开护盾", color: "#74c0fc", rarity: "史诗", weight: 14, threshold: 0.35, shield: 22, maxShield: 60, dur: 6, cooldown: 22 },
    overdrive: { name: "过载弹幕", desc: "射速 +18%,承伤 +18%", color: "#ffd43b", rarity: "史诗", weight: 12, cooldownMult: 0.18, damageTakenMult: 0.18 },
  },
  elite: {
  ...
  endless: {
    hpMult: 0.7, maxEnemies: 15, diffKey: "normal", startingDrafts: 2, dmgRampTime: 270, dmgRampMult: 3.2, enemyHpBaseMult: 1.55, enemyHpRampTime: 240, enemyHpRampMult: 3.0,
    worldInterval: 40, powerupChance: 0.09,
    eventInterval: 24, eventDuration: 17, eventClearScore: 650, eventCleanShield: 16, eventCleanShieldDur: 4,
    spawn: { initialDelay: 0.8, intervalBase: 1.65, intervalDecay: 0.009, intervalMin: 0.72, countBase: 2, countStepSec: 14, countStepMax: 6 },
    ...
    pools: [
      ...
      { until: 160, enemies: ["small", "medium", "large", "gunner", "splitter", "sniper", "detonator", "jammer", "shieldCarrier", "kamikaze"] },
      { until: 250, enemies: ["small", "medium", "large", "gunner", "splitter", "sniper", "detonator", "jammer", "support", "shieldCarrier", "phantom", "phantom", "carrier", "kamikaze"] },
      { enemies: ["small", "medium", "large", "gunner", "splitter", "sniper", "detonator", "jammer", "support", "shieldCarrier", "shieldCarrier", "phantom", "phantom", "carrier", "carrier", "carrier", "kamikaze", "kamikaze"] },
    ],
    events: [
      { key: "supplyStorm", name: "补给风暴", color: "#38d9a9", sub: "掉落率上升", routeBias: "生存", powerupChanceAdd: 0.14 },
      { key: "eliteAirspace", name: "精英空域", color: "#ff8787", sub: "精英敌增多", routeBias: "主炮", eliteChance: 0.52, spawnBonus: 1 },
      { key: "overloadField", name: "过载磁场", color: "#ffd43b", sub: "分数提升,威胁提升", routeBias: "风险", scoreBonus: 0.16, threatGainMult: 1.35 },
      { key: "ambush", name: "伏击航道", color: "#74c0fc", sub: "敌群加密,补给偏防御", routeBias: "生存", spawnBonus: 2, powerupChanceAdd: 0.04, forceDrop: "heal" },
      { key: "armoredAirspace", name: "重甲空域", color: "#74c0fc", sub: "敌机生命提升,补给偏防御", routeBias: "生存", enemyHpMult: 0.42, powerupChanceAdd: 0.03, forceDrop: "heal" },
      { key: "noHitRun", name: "无伤穿越", color: "#38d9a9", sub: "限时无伤,受击目标失败", routeBias: "生存", minTime: 70, spawnBonus: 1, powerupChanceAdd: 0.03, forceDrop: "heal", scoreBonus: 0.08, noHitGoal: true },
      { key: "annihilationOrder", name: "歼灭令", color: "#ffd43b", sub: "限时击杀目标,完成才结算", routeBias: "主炮", minTime: 80, enemyType: "medium", enemyChance: 0.52, spawnBonus: 2, scoreBonus: 0.06, killGoal: 18 },
      { key: "aceHunt", name: "猎杀王牌", color: "#ff6b6b", sub: "精英敌增多,击破王牌目标", routeBias: "主炮", minTime: 100, enemyType: "gunner", enemyChance: 0.58, eliteChance: 0.76, spawnBonus: 1, scoreBonus: 0.09, eliteGoal: 5 },
      { key: "repairConvoy", name: "维修航队", color: "#51cf66", sub: "支援机增多,敌群更耐打", routeBias: "导弹", minTime: 110, enemyType: "support", enemyChance: 0.44, spawnBonus: 1, enemyHpMult: 0.24, scoreBonus: 0.08 },
      { key: "ionStorm", name: "离子风暴", color: "#cc5de8", sub: "周期镭射航道", routeBias: "激光", laserEvery: 3.8, laserDelay: 1.1, warn: 0.66, dur: 0.55, width: 38, damage: 8, jitter: 210 },
      { key: "crossfire", name: "交叉火线", color: "#ff922b", sub: "周期侧向弹幕", routeBias: "生存", minTime: 120, bulletEvery: 3.5, bulletDelay: 0.9, bulletRows: 6, bulletSpeed: 270, bulletDamage: 7, scoreBonus: 0.08 },
      { key: "jammerCloud", name: "扰频云层", color: "#15aabf", sub: "干扰机增多", routeBias: "追踪", spawnBonus: 1, jammerChance: 0.42 },
      { key: "sniperLockdown", name: "狙击封锁", color: "#e64980", sub: "狙击机增多,分数提升", routeBias: "主炮", minTime: 90, enemyType: "sniper", enemyChance: 0.5, spawnBonus: 1, powerupChanceAdd: 0.02, scoreBonus: 0.08 },
      { key: "minefield", name: "爆雷空域", color: "#fab005", sub: "爆雷机增多,分数和威胁提升", routeBias: "导弹", minTime: 130, enemyType: "detonator", enemyChance: 0.48, spawnBonus: 1, scoreBonus: 0.10, threatGainMult: 1.25 },
      { key: "shieldWall", name: "护盾纵队", color: "#74c0fc", sub: "护盾运输机增多,敌群更耐打", routeBias: "主炮", minTime: 140, enemyType: "shieldCarrier", enemyChance: 0.48, spawnBonus: 1, enemyHpMult: 0.18, scoreBonus: 0.09 },
      { key: "phantomWing", name: "幻影编队", color: "#22d3ee", sub: "高速幻影机增多", routeBias: "追踪", minTime: 150, enemyType: "phantom", enemyChance: 0.54, spawnBonus: 1, powerupChanceAdd: 0.02, scoreBonus: 0.09 },
      { key: "carrierRaid", name: "母舰压境", color: "#9775fa", sub: "母舰机增多,击毁后分裂僚机", routeBias: "主炮", minTime: 170, enemyType: "carrier", enemyChance: 0.38, spawnBonus: 1, enemyHpMult: 0.18, scoreBonus: 0.10 },
      { key: "shieldedAmbush", name: "盾阵伏击", color: "#74c0fc", sub: "护盾机和精英混编", routeBias: "主炮", minTime: 105, enemyType: "shieldCarrier", enemyChance: 0.52, eliteChance: 0.36, spawnBonus: 2, enemyHpMult: 0.20 },
      { key: "rearAssault", name: "尾袭警报", color: "#ff4d4f", sub: "自爆机从后方追踪撞击", routeBias: "生存", minTime: 115, enemyType: "kamikaze", enemyChance: 0.58, spawnBonus: 1, scoreBonus: 0.06 },
      { key: "sniperCrossfire", name: "狙击交叉线", color: "#e64980", sub: "狙击机配合侧弹封路", routeBias: "生存", minTime: 160, enemyType: "sniper", enemyChance: 0.55, spawnBonus: 1, bulletEvery: 3.3, bulletDelay: 0.9, bulletRows: 6, bulletSpeed: 285, bulletDamage: 7, scoreBonus: 0.08 },
      { key: "blackoutRaid", name: "黑障突袭", color: "#15aabf", sub: "扰频和精英压制武器", routeBias: "追踪", minTime: 180, enemyType: "jammer", enemyChance: 0.5, eliteChance: 0.46, spawnBonus: 2, jammerChance: 0.28, threatGainMult: 1.22 },
    ],
    boss: {
      firstDelay: 28, interval: 32, baseHpMult: 1.35, hpStep: 0.11, hpStepMax: 14,
      affixes: [
        { key: "armored", name: "装甲", desc: "生命更高", color: "#74c0fc", hpMult: 0.24, scoreMult: 1.12 },
        { key: "rapid", name: "急袭", desc: "攻击更快", color: "#ff8787", fireMult: 0.78, scoreMult: 1.15 },
        { key: "prism", name: "棱镜", desc: "周期瞄准镭射", color: "#cc5de8", attack: "laser", every: 5.0, warn: 0.52, dur: 0.7, width: 44, damageMult: 0.9, scoreMult: 1.16 },
        { key: "barrage", name: "弹幕", desc: "周期环形弹幕", color: "#ff922b", attack: "ring", every: 5.7, count: 16, speed: 240, damageMult: 0.82, scoreMult: 1.16 },
        ...
        { key: "ironclad", name: "铁幕", desc: "重甲且攻击略快", color: "#adb5bd", hpMult: 0.32, fireMult: 0.9, scoreMult: 1.18 },
        { key: "sniperEscort", name: "狙卫", desc: "周期投放狙击僚机", color: "#e64980", attack: "escort", every: 7.4, enemy: "sniper", elite: "charger", maxAdds: 3, scoreMult: 1.18 },
        { key: "rearGuard", name: "尾袭", desc: "周期投放自爆追猎机", color: "#ff4d4f", attack: "escort", every: 6.6, enemy: "kamikaze", adds: 2, maxAdds: 4, scoreMult: 1.18 },
        { key: "prismArmor", name: "晶甲", desc: "强化生命并周期镭射", color: "#cc5de8", hpMult: 0.14, attack: "laser", every: 4.8, warn: 0.5, dur: 0.75, width: 48, damageMult: 0.92, scoreMult: 1.2 },
        { key: "crossBarrage", name: "交叉弹幕", desc: "高密度周期环形弹", color: "#ff922b", hpMult: 0.08, attack: "ring", every: 5.2, count: 20, speed: 250, damageMult: 0.86, scoreMult: 1.2 },
      ],
    },
  },
