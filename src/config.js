...
const CONFIG = {
  ...
  bonusOrder: ["damage", "fireRate", "range", "maxHp", "reinforcedHull", "armorPlating", "fieldRepair", "leech", "missileRack", "pierce", "chainSpark", "pointDefense", "salvage", "kineticAmmo", "heavyRounds", "armorPiercer", "sideCannons", "laserLens", "laserSplitter", "swarmCore", "homingShards", "explosivePayload", "clusterWarheads", "missileInterceptor", "magnetCore", "comboBattery", "comboSurge", "chargeAmp", "executioner", "reactiveArmor", "lastStand", "glassCannon", "bossHunter", "adrenaline", "emergencyBarrier", "overdrive"],
  bonuses: {
  ...
  challenge: { rulesVersion: 20, splits: [30, 60, 120] },
