...
const CONFIG = {
  ...
  powerup: { radius: 14, speed: 130, dropChance: 0.14, healAmount: 12, autoInterval: 5, magnetRadius: 40, magnetSpeed: 640, chipMinPower: 5, chipMinEndlessTime: 45,
  ...
  chips: {
    laserFocus: { name: "聚焦激光", desc: "激光更窄,伤害更高", color: "#cc5de8", duration: 12, laserWidthMult: 0.72, laserDamageBonus: 2, laserDurationBonus: 0.06 },
    homingSwarm: { name: "蜂群追踪", desc: "追踪弹更多,锁定更远", color: "#4dabf7", duration: 11, intervalMult: 0.72, extraCount: 1, targetRange: 430, damageBonus: 1 },
    missileBarrage: { name: "导弹齐射", desc: "导弹更多,爆炸范围扩大", color: "#ff922b", duration: 11, intervalMult: 0.78, extraCount: 1, damageBonus: 2, splashMult: 1.25 },
    chargeCore: { name: "蓄能核心", desc: "蓄力更快,冷却更短", color: "#ffd43b", duration: 10, chargeRate: 1.45, cooldownMult: 0.62, boostBonus: 3 },
    capacitor: { name: "电容护盾", desc: "过载层可抵消伤害", color: "#74c0fc", duration: 14, block: 22 },
  ...
  bonusOrder: ["damage", "fireRate", "range", "maxHp", "leech", "missileRack", "pierce", "chainSpark", "salvage", "kineticAmmo", "laserLens", "swarmCore", "explosivePayload", "magnetCore", "comboBattery", "chargeAmp", "executioner", "reactiveArmor", "glassCannon", "bossHunter", "adrenaline", "emergencyBarrier", "overdrive"],
  bonuses: {
  ...
  endless: {
    ...
    events: [
      { key: "supplyStorm", name: "补给风暴", color: "#38d9a9", sub: "掉落率上升", powerupChanceAdd: 0.22 },
      { key: "eliteAirspace", name: "精英空域", color: "#ff8787", sub: "精英敌增多", eliteChance: 0.48, spawnBonus: 1 },
      { key: "overloadField", name: "过载磁场", color: "#ffd43b", sub: "分数提升,威胁提升", scoreBonus: 0.25, threatGainMult: 1.3 },
      { key: "ambush", name: "伏击航道", color: "#74c0fc", sub: "敌群加密,补给偏防御", spawnBonus: 2, powerupChanceAdd: 0.08, forceDrop: "heal" },
    ],
