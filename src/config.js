...
const CONFIG = {
  ...
  powerup: { radius: 14, speed: 130, dropChance: 0.14, healAmount: 12, autoInterval: 5, magnetRadius: 40, magnetSpeed: 640, chipMinPower: 5, chipMinEndlessTime: 30, chipDraftInterval: 30, chipBossDraftDelay: 15,
  ...
  bonuses: {
    ...
    shieldBreaker: { name: "破盾电荷", desc: "对敌方护盾伤害 +60%,击破护盾时震击附近敌人", color: "#74c0fc", rarity: "稀有", weight: 34, shieldDamageMult: 0.60, breakDamage: 6, range: 145 },
  ...
  challenge: { rulesVersion: 61, splits: [30, 60, 120] },
