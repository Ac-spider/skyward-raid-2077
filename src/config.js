...
const CONFIG = {
  ...
  bonuses: {
    ...
    stableFire: { name: "稳态火控", desc: "生命高于70%时全武器伤害 +18%", color: "#38d9a9", rarity: "稀有", weight: 32, hpThreshold: 0.70, damageMult: 0.18 },
    ...
    eliteHunter: { name: "王牌猎手", desc: "对精英敌伤害 +35%", color: "#ff6b6b", rarity: "稀有", weight: 32, eliteDamageMult: 0.35 },
