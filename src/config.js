...
const CONFIG = {
  ...
  chips: {
    laserFocus: { name: "聚焦激光", desc: "激光更窄,伤害更高", color: "#cc5de8", duration: 12, laserWidthMult: 0.76, laserDamageBonus: 1, laserDurationBonus: 0.04 },
    homingSwarm: { name: "蜂群追踪", desc: "追踪弹更多,锁定更远", color: "#4dabf7", duration: 11, intervalMult: 0.78, extraCount: 1, targetRange: 390, damageBonus: 1 },
    missileBarrage: { name: "导弹齐射", desc: "导弹更多,爆炸范围扩大", color: "#ff922b", duration: 11, intervalMult: 0.84, extraCount: 1, damageBonus: 1, splashMult: 1.18 },
    chargeCore: { name: "蓄能核心", desc: "蓄力更快,冷却更短", color: "#ffd43b", duration: 10, chargeRate: 1.32, cooldownMult: 0.70, boostBonus: 2, pickBuff: { label: "能量 +8", energy: 8 } },
    capacitor: { name: "电容护盾", desc: "过载层可抵消伤害", color: "#74c0fc", duration: 14, block: 18, pickBuff: { label: "护盾 +10", shield: 10, dur: 4 } },
  ...
  bonuses: {
    ...
    painConverter: { name: "痛觉转换", desc: "受伤时将损失生命转为必杀能量", color: "#f06595", rarity: "稀有", weight: 28, energyPerHp: 0.9, maxEnergy: 30 },
    ...
    magnetCore: { name: "回收磁场", desc: "补给吸附范围 +55%", color: "#20c997", magnetMult: 0.55 },
    ...
    lastStand: { name: "黑匣子保险", desc: "致命伤保留 1 生命并展开护盾", color: "#845ef7", rarity: "史诗", weight: 12, shield: 26, maxShield: 70, dur: 5, cooldown: 70 },
  ...
  endless: {
    ...
    events: [
      ...
      { key: "armoredAirspace", name: "重甲空域", color: "#74c0fc", sub: "敌机生命提升,补给偏防御", routeBias: "生存", enemyHpMult: 0.35, powerupChanceAdd: 0.04, forceDrop: "heal" },
      ...
      { key: "repairConvoy", name: "维修航队", color: "#51cf66", sub: "支援机增多,敌群更耐打", routeBias: "导弹", minTime: 110, enemyType: "support", enemyChance: 0.4, spawnBonus: 1, enemyHpMult: 0.18, scoreBonus: 0.09 },
      ...
      { key: "shieldWall", name: "护盾纵队", color: "#74c0fc", sub: "护盾运输机增多,敌群更耐打", routeBias: "主炮", minTime: 140, enemyType: "shieldCarrier", enemyChance: 0.42, spawnBonus: 1, enemyHpMult: 0.12, scoreBonus: 0.10 },
      ...
      { key: "carrierRaid", name: "母舰压境", color: "#9775fa", sub: "母舰机增多,击毁后分裂僚机", routeBias: "主炮", minTime: 170, enemyType: "carrier", enemyChance: 0.34, spawnBonus: 1, enemyHpMult: 0.12, scoreBonus: 0.12 },
      { key: "shieldedAmbush", name: "盾幕伏击", color: "#91a7ff", sub: "监押机护住敌群", routeBias: "主炮", minTime: 150, enemyType: "warden", enemyChance: 0.4, spawnBonus: 1, enemyHpMult: 0.10, scoreBonus: 0.11 },
