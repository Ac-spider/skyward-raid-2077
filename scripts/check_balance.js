...
assert(CONFIG.endlessDifficulties.normal.enemyHpDoubleInterval > CONFIG.endless.enemyHpDoubleInterval, "normal endless enemy HP curve should grow slower than hell");
...
assert.strictEqual(CONFIG.endless.enemyHpBoostMult, 3, "endless enemies should be 3x HP at 60s");
assert.strictEqual(CONFIG.endless.enemyHpDoubleInterval, 120, "endless enemy HP multiplier should grow without creating a wall");
...
assert.strictEqual(game.endlessEnemyHpFloor(), CONFIG.endless.enemyHpFloor, "enemy HP floor should start at the configured opening floor");
between(game.endlessEnemyHpFloor() / focusedDps.earlyFull, 3, 5, "opening enemy floor TTK");
game._endlessT = CONFIG.endless.enemyHpBoostTime;
assert(Math.abs(game.endlessEnemyHpMult() - 3) < 1e-9, "endless enemies should reach 3x HP at 60s");
between(game.endlessEnemyHpFloor() / focusedDps.fourPick, 3, 5, "60s enemy floor TTK");
game._endlessT = CONFIG.endless.enemyHpBoostTime + CONFIG.endless.enemyHpDoubleInterval;
assert(Math.abs(game.endlessEnemyHpMult() - 6) < 1e-9, "endless enemies should reach 6x HP at 120s");
game._endlessT = CONFIG.endless.enemyHpBoostTime + CONFIG.endless.enemyHpDoubleInterval * 2;
assert(Math.abs(game.endlessEnemyHpMult() - 12) < 1e-9, "endless enemies should reach 12x HP at 180s");
game._endlessT = CONFIG.endless.enemyHpFloorTargetTime;
assert.strictEqual(game.endlessEnemyHpFloor(), CONFIG.endless.enemyHpFloorTarget, "200s enemy floor should enter ten-thousand HP territory");
between(game.endlessEnemyHpFloor() / focusedDps.strongRoute, 9, 14, "200s enemy floor TTK for strong focused fire");
game._endlessT = 420;
